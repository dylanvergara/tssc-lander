...
export const siteData = {
  ...
  testimonialCarousels: [
    ...
    },
    {
      ...
      videos: [
        { id: 41, label: '$54k commission month at 24',          sub: 'Before: Door-to-Door Food Sales',   videoId: 'cIKgkBmLNeg', platform: 'youtube' },
        { id: 42, label: '$38k month, $20-30k sustained',        sub: 'Before: Real Estate Sales',         videoId: '0qkQzPdb40s', platform: 'youtube' },
        { id: 43, label: '$270k/mo in revenue from Spain',       sub: 'Before: SaaS Account Executive',    videoId: '6Eu62BkCI7U', platform: 'youtube' },
        { id: 44, label: '$30-40k/mo, zero prior experience',    sub: 'Before: Missionary',                videoId: 'ej2TCqn-FbA', platform: 'youtube' },
        { id: 45, label: '$200k first year, $17k by month 3',    sub: 'Before: Tax Resolution Sales',      videoId: '1Wq1FSPYm5Q', platform: 'youtube' },
        { id: 46, label: '$25k/mo closing, kept his W2',         sub: 'Before: Tech SDR (Cybersecurity)',  videoId: '8bJ2Jq-n1k4', platform: 'youtube' },
        { id: 47, label: '6 figures, doubled co. to $1M/mo',     sub: 'Before: Corporate Healthcare',      videoId: 'LRhqJEXoOZ4', platform: 'youtube' },
        { id: 48, label: '$30k/mo before turning 21',            sub: 'Before: Corporate Insurance SDR',   videoId: '07r72x6zNz0', platform: 'youtube' },
        { id: 49, label: '$18k month from NYC',                  sub: 'Before: Corporate SDR Team Lead',   videoId: 'XfmfnANJ8vc', platform: 'youtube' },
        { id: 50, label: '$30k in first 90 days',                sub: 'Before: Agency and Business Owner', videoId: 'l5A5vnW7n_o', platform: 'youtube' },
      ],
    },
  ],
