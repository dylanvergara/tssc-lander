...
1. SARITH SAJU (8/13/2026): Background: A pharmacist by schooling, Sarith spent six years in pharma before leaving because the work wasn't a good fit. He then spent about a year selling windows. Problem: He struggled for months bouncing between weak offers, making just $1,500 across two months on one. He joined because TSSC looked like a "proven path." Result: After pushing through months of setbacks, he now considers $10K a bad month as an appointment setter, recently hit $24K, and helped generate $3M+ this year. Financial milestone: $24,000. Quote: ""Me working without success for the four to six months... you were watching, you saw that I had the work ethic... and that opened the door."" Advice: "You never know where the work that you put in is gonna pay off." Keep pursuing opportunities, protect your reputation, use available resources, and don't quit during setbacks. Milestone: Consistent income.

2. REDA TALIANI (8/6/2026): Background: At 18, he had no income, skills, or connections. He was in college, working part-time in commission-only sales while pursuing a marketing degree. Problem: He knew he was "severely lacking in skill," had minimal confidence on the phone, and wanted training to get where he wanted to go quicker. Result: He hit $10,006.90 in one month, consistently ranks top-three on his team, and does it on a schedule that included vacation and significant time off. Financial milestone: $10,006.90. Quote: ""I consider, in my opinion, high ticket sales is easy money. I don't consider it difficult money."" Advice: "Sales training is important but it isn't the entire thing." Focus on getting tapped into better opportunities; the right offer can make income "skyrocket." Milestone: Consistent income.

3. MIRIAM CHICANOT (6/25/2026): Background: "I've never actually worked in a 9-5. So, 10 years in the business coaching space." She had retired from her lash clientele after optimizing her business. Problem: She was "very under qualified on paper" despite 10 years of experience, with no degree, and wanted to leverage her existing skills into remote work and greater freedom. Result: She made $13.5K Canadian (~$9.6K USD) in one month as a setter, while gaining more flexibility and building confidence toward closing. Financial milestone: $13.5k. Quote: ""This unlocked everything. It unlocked the doors."" Advice: "You have to get your feet wet and you can't do that by reading. You can't do that without getting in it." Milestone: Consistent income.

4. JAKE MERCADO (5/7/2026): Background: "I was in corporate sales, so door-to-door. I was selling industrial vacuums... I got tired." He was making about $80K right out of college. Problem: He felt capped on income while working excessive hours: "If I'm going to put in the work... I want it to be reflected of how much time I'm actually putting in." Result: He became a remote closer, consistently rivaling his previous income, while gaining the ability to travel, golf Fridays, take random trips, and build the life he wants. Financial milestone: $10k. Quote: ""It's like I want to see exponential growth with the people I'm surrounded with."" Advice: "I mean, certainly take that leap and just do it because you don't know what's going to happen. You don't know who you're going to run into." Milestone: Consistent income.

5. JASE STONE (4/16/2026): Background: Medically retired Marine with no traditional sales experience. Tried roofing, then attended school using military benefits. Income covered bills, but wasn't enough to accelerate moving his family back to Japan. Problem: Roofing wasn't working, and he wanted more than simply covering expenses. He joined for vetted opportunities, job security, and remote income that could work internationally. Result: Made $10,000 commission in his first 18 days, then around $7,000/month into savings, accelerating his timeline to move his family back to Japan. Financial milestone: $10,000. Quote: ""It's allowed my life to grow more rapidly and get me to where I want to be... I see my goals starting to unfold faster and faster."" Advice: "Have more faith in yourself." Stay a student, ask questions, surround yourself with successful people, maintain accountability, and put in the work: "It's based off of work ethic." Milestone: First sale / commission.

6. ETHAN ZHANG (4/9/2026): Background: Dropped out of college at "rock bottom," waking at 2 p.m., going to bed at 6 a.m., planning to do Uber Eats before his car was totaled. Problem: He had sales training but "couldn't" find an opportunity for live reps. He joined to access strong offers and learn how to position himself to actually get hired. Result: At 21, he went from $0 to $15,000/month within six months, earning enough remotely to move to Italy and seriously pursue his dream of becoming an opera singer. Financial milestone: $15,000. Quote: ""I said I could hate it with all my heart... I am not leaving this until I make 10K a month. Because I'm never going to surrender ever again."" Advice: "The start is always going to be the hardest." Join a community, find opportunities, build the skill set, and "just stick through it" until you've proven yourself. Milestone: Offer received.

7. JOSH HUZIY (4/2/2026): Background: "I did cars... ran my own thing exporting vehicles... then ran a solar team... got sick of it and started looking into the online world." Problem: "I didn't really know who to talk to... it's not like they're listed on LinkedIn... just trying to figure out how to get into the space." Result: "I made 14K US... 19.5K Canadian... and I can work from anywhere... went to Austin and BC while making money." Financial milestone: $19,500. Quote: ""If it's working for other people, there's no reason why you can't make it work for yourself."" Advice: "You need to have a big willingness to learn... don't think that you know everything." Milestone: Started the role.

8. ZACH SCHAFFER (3/27/2026): Background: "I can't remember exactly what I was doing work-wise... but I was like I want to do this... he's making way more money... I want to do high ticket." Problem: "Finding the offer... getting on it... that's the real magic... it's really who you know... that's why joining a community is a big part of the secret sauce." Result: "Now we're like mid 20s... super lean... profitable month one... I still have all this MMR coming in... I still got like 20 grand." Financial milestone: $25,000. Quote: ""You're only like one or two skills... probably just one... from really blowing your income up."" Advice: Increase leverage as fast as you can... there's tons of ways... automations, systems... find positions that give you leverage Milestone: Offer received.

9. JORDAN WORTH (3/19/2026): Background: "I was doing sales with the agency... I didn't even know closing was a thing... saw it on Twitter and decided to take some action." Problem: "I wasn't believing what I was selling... I want to sell something that I believe in... something that isn't shady." Result: "Pretty consistent five figure months... all my calls done by 1pm... then I do what I want with life." Financial milestone: $15,000. Quote: ""Getting to a point of closing consistently and then being on a good offer... it is just a match made in heaven."" Advice: "Just jump into an offer... get reps in... network your arse out... what you give out comes back to you." Milestone: Team / scale.

10. JOE EYNON (3/12/2026): Background: "18... didn't want to go to uni," doing an agency and "selling wine software," unsure what he wanted, just "work work work" without clear direction Problem: "Loads of hours, no traveling... wasn't getting any closer" to goals. Also struggled finding good offers and clear promotion paths early on Result: Now a "sales manager earning "10-12K," managing a team, traveling globally (Brazil, Colombia, Morocco), with strong freedom and remote lifestyle Financial milestone: 12K. Quote: ""It is kind of literally everything... all the roles I've gotten have always been like referrals or they know someone... who's put in a word for me."" Advice: Take a bet on yourself... get around the right people... network is everything... even just getting people to like you can take you a long way Milestone: Team / scale.

11. CHRIS PEREIRA (3/6/2026): Background: Worked construction "12-15 hour days," nightclub jobs, telecom sales "banging dials," online fitness coaching, real estate; wanted more freedom beyond showing homes Problem: "Leads started to dry up... commission started to go down." Wanted "something to get to the next level" and reach "15 to 20K" months Result: "Second month, I hit 29,000 Canadian... biggest month 38K," now sustaining "20 to 30 a month" with freedom, travel, and remote lifestyle Financial milestone: $30,000. Quote: ""It was a very, very quick ROI for me and I'll continue to spend money on community and training for the rest of my life."" Advice: Make the leap... be part of a network... trust the process, training, and constant self-development to reach those levels Milestone: Consistent income.

12. JORDAN ZADROZNY (2/26/2026): Background: Dropped out of college... doing door-to-door sales selling high-end steak and seafood from a meat van in Edmonton, knocking doors 8-10 hours a day. Problem: Trying to make money online with ecom and SMMA but never found success... wanted something where I could just focus on sales and not marketing or fulfillment. Result: $54,000 commission month at 24... consistently $20-25K months, traveling the world, tax resident in Qatar with 0% tax, and able to pay my mom's rent. Financial milestone: $54,000. Quote: ""To all my Canadians watching this, high-ticket sales is a cheat code."" Advice: What do you have to lose? Just take the leap. If it works out, great. If it doesn't, at least you know and can move on to the next thing. Milestone: Consistent income.

13. DALTON MARR (2/19/2026): Background: Graduated in 2023... got the corporate job... tech SDR role... dealing with office politics, commuting, and commissions that weren't what they were supposed to be. Problem: He disliked corporate sales and wanted something different: "office politics... commute... commissions weren't what they were supposed to be." He joined after seeing Instagram ads and interviews proving remote sales was "something legit." Result: "Third month... $11.7... more than my tech SDR role... do it from home... go to the gym when you want." He quit corporate after his commission income surpassed his salary. Financial milestone: $11.7...m. Quote: ""As soon as my commission role made more money than my tech role, I instantly knew-this is it. I'm going to go all in."" Advice: Build connections as quick as possible... do your research... watch the interviews... dive deep. It's so doable... there's nothing holding you back except yourself. Milestone: Consistent income.

14. CHRIS CHA (2/12/2026): Background: Spent three years in Korea as a missionary... Bible teacher, youth minister... no formal sales job or commissions, but a lot of persuasion and discussion. Problem: He lacked a clear career path: "No degree that's going to help me get a job... quickest way to increase my income was to capitalize on the communication skills I already have." Result: "In month five or six closing... came off somewhere between $30 to $40K with bonuses... drove about 65% of the team's revenue." Financial milestone: $40K. Quote: ""I close that deal knowing I just changed that person's life... the trajectory of that person's life is now forever different."" Advice: Treat this like your business... stay up late reviewing calls, working your script... if you're not willing to put in the work, you're not going to go that far. Milestone: Consistent income.

15. SOMIL MANDER (1/29/2026): Background: At 18-19 I was in corporate insurance sales... B2B employee benefits... base plus commission, working from the office making mid to high five figures. Problem: He felt there was more opportunity than corporate: "Seeing your stuff I thought there's more to sales so I wanted to see... online sales plus sales skills made sense." Result: "Joined at 19... made $30,000 a month before turning 21... managed multiple sales teams and traveled the world working remotely." Financial milestone: $30,000. Quote: ""If you want a different result, you need a different process... you want five instead of four, you have to add something."" Advice: Remember your brain is designed to keep you safe, not happy... if you want a different result, you need a different process. Milestone: Consistent income.

16. VALENTIM DURAND (1/15/2026): Background: He was in the Air Force Academy studying engineering... tried entrepreneurship like running a fitness offer, but nothing substantial. Problem: He believed location and language were barriers: "I had this limiting belief since I'm from Portugal that it was impossible because it's not my main language." Result: "Hit $10K in my third month on my second offer as a phone setter... working remotely from Portugal and earning far above the local average." Financial milestone: $10,750. Quote: ""Your fear is not going to bring you where you want to be... just do the inputs, trust the process, and stay consistent."" Advice: Take the leap of faith and go all in... do everything you can to make it happen. Milestone: Offer received.

17. DAVID LEPIRD (1/8/2026): Background: "I owned a sales agency and a commercial flooring company... also worked as a manufacturer sales rep traveling about 200 nights a year selling construction products." Problem: He wanted a lifestyle change: "I was making good money but staying out 200 nights a year... it wasn't good for the marriage, the kids, or my lifestyle." Result: "In the first three months I earned over $30K closing... just under $9K month one, over $10K month two, and almost $12K month three." Financial milestone: $30K. Quote: ""I was staying out 200 nights a year... now I can be home with my kids, work out, skateboard with them, and still make money."" Advice: Your network is your net worth... people hire people they trust, and being around the right network gives you the opportunity. Milestone: Team / scale.

18. NOAH MICKA (9/25/2025): Background: Sold solar door-to-door for 18 months after college. Graduated with a finance degree, turned down a Deloitte offer, and later started a lighting business with a friend. Problem: Burned out from long sales cycles and door-to-door grind. Needed structure, mentorship, and a high-energy team environment with better pay and fulfillment. Result: Now earns $14.2K/month setting remotely for a real estate offer while still running his lighting business. Top performer, working flexible hours with freedom and growth. Financial milestone: $14,800. Quote: ""Last month I made $14,800 - the most I've ever made in my life - and I'm doing it all from home while still running my other business."" Advice: Go all in-commit early, take massive action, don't fear leaving bad offers, and leverage the community to grow faster and secure better opportunities. Milestone: Started the role.

19. ROBBIE BHANGAL (9/18/2025): Background: Studied finance and worked two years in a finance job. Knew he didn't want a traditional career and wanted a skill-based path to success. Problem: Felt stuck in a corporate role, unsure how to transition into something scalable and performance-driven. Needed mentorship and a shortcut to real opportunities. Result: Landed his first sales job ever through the community and hit $12K in a single month as a setter. ROI'd his investment 5-6x in six months. Financial milestone: $12,000. Quote: ""I joined mid-February and hit $12K by August. That's a 5x ROI-there's nothing else like it."" Advice: "Stick to setting before rushing into closing. Learn outbound-it's what turns you from a zoo lion into a hunter." Milestone: Started the role.

20. DEAVIN RENCHER (9/4/2025): Background: Worked in tech sales as an SDR for a cybersecurity company. Hit quota easily but wanted more income and flexibility, so he joined the Slack version of the community for $30/month. Problem: Felt capped by his W2 job and unsure if high-ticket sales was real. Wanted to test the waters safely without risking his income or responsibilities. Result: Now earns $25K/month remote closing while still managing a tech sales team. Bought a house, travels, invests in trading, and enjoys full financial comfort and flexibility. Financial milestone: $25,000. Quote: ""You can't reverse engineer this. You just have to be in the right spot talking to the right people-networking is everything."" Advice: "Dip your toes in first. Keep your W2 until you find a good offer, build connections, and you'll replace your income faster than you think." Milestone: Team / scale.

21. JOSH PINNER (8/21/2025): Background: Worked in roofing and construction sales after serving in the Marines. Made good money but was overworked, driving for hours daily, and unfulfilled. Problem: Felt "handicapped" by time, travel, and inconsistency. Wanted stability, freedom, and alignment with his values-helping people, not chasing insurance claims. Result: Now earns $15K/month remote closing, selling real estate programs for veterans. Works from home, travels freely, and enjoys time with his wife and dogs. Financial milestone: $15,000. Quote: ""I wake up, hit the gym, make a few thousand dollars from home, then hang out with my wife-there's nothing that compares to this freedom."" Advice: "Go all in. Stop wasting time doubting yourself-if you want it bad enough, you'll figure it out and change your life." Milestone: Consistent income.

22. AARON FARRELL (8/14/2025): Background: He worked full-time in oil refineries and mines across Canada as a pipe fitter for five years before quitting to go all in on sales. Problem: He struggled sending 100+ IG DMs daily with no results and poor offers. He joined the community to learn resume, Loom, and proper application structure. Result: He made $11.5K last month, $13K in January, now landing stable, remote roles including one with a $50K base salary and a 100+ person sales team. Financial milestone: $11,500. Quote: ""The biggest thing is the job opportunities in the community... I think that's probably my top thing about the community."" Advice: "Get proper help... be active, get reps, and hop in as many interviews as possible." Milestone: Started the role.

23. JULIAN DUJARRIC (7/3/2025): Background: Worked as a public speaker and broadcast journalist for 11 years, then ran his own marketing agency during COVID, often traveling and hustling nonstop. Problem: Burnt out from constant travel and inconsistent income. Needed freedom, structure, and a sustainable career that used his communication skills. Result: Now earns $8K-$10K/month as a remote appointment setter for a seven-figure finance offer. Built a steady remote income with future plans to move into closing. Financial milestone: $10K. Quote: ""I 10x'd my investment in the community-it paid dividends not just in income but in the people I met and the freedom I gained."" Advice: "Go all in for six months. Surround yourself with good salespeople-proximity and consistency will change everything." Milestone: Team / scale.

24. BURHAN AHMED (4/17/2025): Background: Started day trading in high school, flipped pools and PlayStations for cash, then moved into small sales gigs like resume writing-earning minimal commissions while learning. Problem: Faced scams, bad offers, and lack of guidance early on. Wanted faster growth, mentorship, and a real network instead of trying to learn everything alone. Result: Now earns consistent five-figure commission months at 22, selling B2B remotely, with financial freedom and long-term investment goals through remote closing. Financial milestone: $15K. Quote: ""Nothing changes if you won't change."" Advice: Invest in yourself early. Focus on one skill, get around the right people, take risks, and use credit or resources to learn faster and grow your network. Milestone: Started the role.

25. NOAH SUSONG (4/10/2025): Background: He was a college baseball player turned email marketer, designing emails alone for hours, earning little, and craving a more social, fulfilling career. Problem: He hated isolation and burnout from agency work and lacked business direction; he joined for mentorship, speed, and a network to shortcut success. Result: He became a top setter, moved to Austin, transitioned into closing, built financial independence, and began launching his own brand and software projects. Quote: ""I have made years' worth of progress in a short amount of time because I surrounded myself with people like Dylan."" Advice: Join a community early, drop your ego, network with people ahead of you, and grind hard-time is money, so invest to shrink your success timeline. Milestone: Team / scale.

26. MOE ISMAIL (3/26/2025): Background: He was in high school, trying email marketing, barely spoke English, and wasn't making progress financially or professionally. Problem: He struggled with English, lack of opportunities, and timezone barriers; he joined to find mentorship, roles, and a supportive network. Result: He's earned $5-7K monthly, surpassed $1M in sets, lives freely in the Maldives, and plans to retire his father. Financial milestone: $5. Quote: ""Being able to make at least like 4,000, 3,000 at the very minimum-it's been life-changing to say the least."" Advice: Take sales seriously, get daily reps in, invest in mentorships, and build genuine connections-success comes from wanting it badly enough. Milestone: Started the role.

27. JAKE SKINNER (2/11/2025): Background: Worked in property management and corporate sales, managing a 12-person SDR team and earning $5-6K/month. Wanted freedom, creativity, and control over income. Problem: Felt trapped in micromanaged corporate structures with limited growth. Needed flexible, performance-based work that matched his independent drive. Result: Now earns up to $18K/month closing remotely while living in New York City. Built savings, moved cross-country, and achieved full financial independence. Financial milestone: $18,000. Quote: ""I made more my first month working two hours a day in high ticket than I did in 40 hours at my full-time job."" Advice: "Join the community and commit. If you're lost on what's next, this is the answer-10K to 20K months are 100% possible." Milestone: Consistent income.

28. BRADY BOOTH (1/17/2025): Background: Dropped out of college, resold PS5s and sneakers, then worked 12-hour shifts in a Kohl's warehouse making little money and surrounded by older, unhappy coworkers. Problem: Wanted to earn based on performance, not hours. Needed freedom to work from anywhere and escape low hourly pay and unfulfilling work. Result: Now earns up to ~$10K/month DM setting. Collected nearly $1M in sales, works from his phone anywhere in the world, and enjoys full lifestyle freedom. Financial milestone: $10K. Quote: ""I'm financially stable, sending text messages on my phone for a few hours a day-it's nuts."" Advice: "Keep your head down, apply yourself, join a community, and network. Connections are everything-learn to stand out and be different from everyone else." Milestone: Consistent income.

29. MAURICIO GARRIDO (12/30/2024): Background: He was selling solar door-to-door and running a small food business, struggling to find consistent, high-quality sales opportunities. Problem: He had solid sales skills but couldn't land reliable remote roles; other training programs didn't help him secure real jobs. Result: He earned $10K in a month through DM closing, transitioned fully into remote sales, and now runs his business passively while selling full-time. Financial milestone: $10,000. Quote: ""I saw my first bad offer as my opportunity to understand the space-and that experience helped me get to my $10K month."" Advice: Start networking immediately, make genuine connections-not just job requests-and take action early to accelerate results. Milestone: Consistent income.

30. APOSTALOS STAMATAKIS (12/10/2024): Background: Worked as a SaaS Account Executive in Europe for 3-4 years. Top performer but felt stagnant and unable to grow further. Problem: Felt stuck without growth in SaaS. Wanted to keep improving, find new industries, and work with ethical, high-performing teams. Result: Now closing $270K/month in revenue, earning multi-five-figure commissions, working remotely from Spain, helping people daily, and loving the freedom and growth. Financial milestone: multi-five-figure days (e.g. $22K). Quote: ""It's all the best things I had while working in SaaS with none of the negatives... every person I speak to is interested in solving their issue with my help."" Advice: "Always work with serious, ethical people... follow the process exactly, invest in your network, and go for offers with strong coaching." Milestone: Consistent income.

31. KAM IN (12/6/2024): Background: Played Division 1 football, then worked manual labor laying rugs while couch-surfing in Minnesota, unsure of his long-term direction. Problem: Wanted freedom and purpose but didn't know how to start in sales. Tried online methods before but lacked structure, mentorship, and real opportunities. Result: Now lives in Austin, TX, earning close to $10K/month setting for two offers. Has booked over $1.3M in closed revenue and built a lifestyle around freedom and growth. Financial milestone: $1,000. Quote: ""I texted my mom-this is the most money I've ever seen in my bank account in my life... all from working online."" Advice: "Time kills all deals. Bet on yourself, take risks early, and stop waiting-every month you delay changes the trajectory of your future." Milestone: Offer received.

32. DREW DOWD (11/22/2024): Background: Worked in corporate healthcare recruiting for two years. Skilled at cold calling and communication but frustrated by bureaucracy, capped growth, and lack of recognition. Problem: Corporate job offered no real advancement despite strong performance. Wanted to control income and escape slow, political systems. Result: Now Head of Operations at a high-ticket company, earning six figures remotely after joining as a closer. Helped double company revenue from $500K to nearly $1M/month in five months. Financial milestone: $500K. Quote: ""I just went in, grinded my face off, fixed problems, and doubled the company in five months."" Advice: "If you work hard and take initiative, you'll stand out fast. The bar is low-be the one who actually executes." Milestone: Team / scale.

33. JARYD JEAN-FELIX (11/20/2024): Background: Worked in software sales (SDR  AE) after college. Earned six figures but felt unfulfilled by meetings and corporate structure. Problem: Wanted faster-paced sales, real conversations, and remote freedom. Tired of long meetings and "not actually selling." Result: Now earns consistent five-figure months taking inbound calls from home. Made $10K part-time before going full-time and 10x'd his ROI on the community within four months. Financial milestone: $10K. Quote: ""I made 10K working four hours a day just taking calls-why wouldn't I go all in?"" Advice: "Stop overthinking. When the opportunity shows up, take it and run with it-six months from now you'll wish you started sooner." Milestone: Consistent income.

34. GARY ROUSE (9/22/2024): Background: Worked in solar sales after serving in restaurants. Felt stuck, lacked alignment with the product, and wanted more freedom and purpose in his work. Problem: Couldn't sell something he didn't believe in. Needed an offer aligned with his values and a real network to find legitimate, fulfilling opportunities. Result: Now earns $8K-$14K/month closing remotely for a hybrid agency/coaching business. Paid off debt, reinvests in training, and lives on his own schedule. Financial milestone: $14K. Quote: ""I can't sell something I don't believe in. Now I'm helping therapists make more money and help more people-it's life-changing."" Advice: "Don't chase desperate offers. Learn, align with what you care about, and hold the frame-you'll stand out instantly." Milestone: Team / scale.

35. CADEN HSIEH (9/6/2024): Background: Ran a small marketing agency in college, earning $2K/month doing fulfillment work he disliked. Wanted something scalable with less overhead. Problem: Struggled with bad offers and lack of sales experience. Joined the community seeking vetted opportunities, mentorship, and real growth in remote closing. Result: At 19 years old, now earns $13.3K/month (CAD) closing real estate offers remotely while attending college and serving as frat president. Works just 2-4 calls daily. Financial milestone: $13,300. Quote: ""I made $13,000 this month while in college and running a frat-just taking calls from my laptop."" Advice: "Invest in your sales skills early. Don't chase shortcuts-build connections genuinely, learn from bad offers, and your big opportunity will come." Milestone: Team / scale.

36. NICK VAUGHAN (8/19/2024): Background: He worked remote entertainment sales and ran a small business but earned low income and wanted more freedom, travel, and alignment with his work. Problem: He felt stuck with low-paying roles, little growth, and no lifestyle flexibility; he joined to move into high-ticket remote sales and level up quickly. Result: He became a high-ticket closer earning $1K+ commission days, traveling freely across the U.S. and Canada while enjoying company retreats and remote living. Financial milestone: $1,000+. Quote: ""I drove up to Canada, took one call, made $700 in an hour-and spent the rest of the day on the lake."" Advice: Bet on yourself, take risks, network relentlessly, and put your back against the wall-growth happens when it's uncomfortable and you go all in. Milestone: Team / scale.

37. ANGEL MARTINEZ (8/13/2024): Background: Worked retail and at Chase Bank, then as a UFC Gym trainer. Earned ~$36K/year in California. Studied computer engineering before switching paths. Problem: His telemarketing job paid poorly and felt outdated. Wanted to earn more, work remotely, and join a network of like-minded people succeeding in high-ticket sales. Result: Now earns ~$15K/month closing remotely. Works 3-4 calls per day, sets his own schedule, and enjoys freedom, flexibility, and a lifestyle he loves. Financial milestone: $14,967. Quote: ""I'm working less, enjoying my time, working from anywhere... I can block out my schedule if I have a family event, and I'm taking home 15K."" Advice: "Get yourself in a community like Serial Sales... practice interviewing, apply to offers that match your skills, and find something you love doing." Milestone: Consistent income.

38. SAM WHEELER (8/9/2024): Background: He worked in corporate home-security sales, earning decent money but stuck in a cubicle with no freedom or fulfillment. Problem: He felt trapped by the 9-5 routine and tried other online paths that failed; he wanted freedom, better pay, and control over his time. Result: He hit $10K/month within 60 days of joining, working remotely as a high-ticket closer, enjoying flexibility, ownership, and full independence. Financial milestone: $10,000. Quote: ""I made my investment back in the second month and hit $10K in the third-all from my home office."" Advice: Take risks, invest in yourself, and outwork others-if what you're doing hasn't worked, change your approach and take action immediately. Milestone: Consistent income.

39. DIEGO MORALES (6/18/2024): Background: Worked at Chase Bank as a teller after college and briefly at Target. Tried dropshipping and SMMA but failed. Wanted financial growth and freedom from corporate limits. Problem: Felt stuck in low-paying, bureaucratic jobs. Struggled to find direction after college and needed a real vehicle to earn based on effort, not hours. Result: Quit his job, joined the community, and in his first month made $10K as an appointment setter. Now works remotely, learning fast, and thriving in a high-performance team. Financial milestone: $10,000. Quote: ""I quit my job, went all in, and made $10,000 in my first month-more than I ever thought possible that fast."" Advice: "Don't be afraid. Go all in. Show up even when you don't feel like it-your best days often come right after your worst ones." Milestone: First sale / commission.

40. TY NAHORNEY (6/14/2024): Background: He worked as a pizza delivery driver after dropping out of university, unsure of his career direction and searching for a business path without a degree. Problem: He lacked confidence, connections, and a clear path to build real skills-he needed structure, mentorship, and a way to fast-track into sales success. Result: He became a top-performing setter earning $10K/month, working 10-hour days, mastering sales skills, and preparing to transition into closing roles. Financial milestone: $10,000. Quote: ""I was turned down for the job, created a custom script and audio pitch, sent it to the manager-and an hour later, I was on the team."" Advice: Take the leap, invest in yourself, and commit at least six months-success requires discomfort, persistence, and consistent action before results come. Milestone: Consistent income.

41. GARRET THROWER (5/26/2024): Background: Worked 60-hour weeks in hospitality management running large events. Previously bartended and cold-called part-time while in college, feeling stuck and exhausted. Problem: Wanted freedom and fulfillment. Struggled to find legitimate offers and direction while trying to break into sales alone through random online leads. Result: Now earns $13K/month by month two setting for top offers. Works fully remote with elite teams, enjoys freedom, and replaced corporate stress with growth-driven culture. Financial milestone: $13,000. Quote: ""I was managing 100 people, working 60 hours a week. Now I work from home, make more, and everyone I work with is obsessed with being the best."" Advice: "Accept that it'll suck at first. Drop job security fears and commit-sales is about becoming the best version of yourself." Milestone: Offer received.

42. NOAH BURTON (3/29/2024): Background: He was in the Air Force, ran small service businesses, and tried real estate coaching but struggled with time, direction, and sustainable income. Problem: He lacked guidance, worked exhausting hours, and couldn't find legitimate, flexible online opportunities until joining the community. Result: He earns $5K monthly as a DM setter while serving full-time in the military, working about seven hours a week with full security and freedom. Financial milestone: $5,000. Quote: ""There are cheat codes in the community you can't find anywhere else-it's literally the only place where you don't have to do cold outreach."" Advice: Stay consistent, keep networking, take honest self-inventory, and surround yourself with winners-progress happens when you never stop moving forward. Milestone: Consistent income.

43. JAKE PASTICK (3/13/2024): Background: Worked eight years in corporate account management for major brands. Felt capped, unfulfilled, and tired of agency politics and early meetings. Problem: Wanted freedom, income growth, and performance-based pay. Corporate roles lacked competition, ownership, and control over results. Result: Now a remote closer earning double his previous income. Gained time freedom, flexibility, and fulfillment while learning real estate sales firsthand. Financial milestone: $14K. Quote: ""My third check covered my burn rate-and I realized if that's the floor, the ceiling's limitless."" Advice: "Go all in for six months. Surround yourself with good salespeople-proximity and consistency will change everything." Milestone: Team / scale.

44. DANIEL FERNANDEZ (12/22/2023): Background: Resold high-end watches ($1K-$15K) and tried multiple online ventures without stable success. Joined after an unsatisfying role from another program. Problem: Wanted career growth and better income after realizing his first sales role lacked long-term potential or support. Result: Now earns $10K/month consistently as a triage appointment setter, helping build out a growing offer and negotiating higher pay and responsibility. Financial milestone: $12,000. Quote: ""I was clearing 10K months consistently... making more than most closers."" Advice: "If you're young and want momentum, sales is the best vehicle-there's nothing else that can get you results this fast." Milestone: Started the role.

45. DAVID HESS (12/17/2023): Background: Worked 10 years in real estate marketing, climbing the corporate ladder but realizing his income potential was capped. Tried drop-shipping and insurance sales before discovering high-ticket sales. Problem: Needed a real opportunity, not another scam or course. Struggled to find trustworthy offers and balance a full-time 9-5 job while transitioning to remote sales. Result: Now earns $6K-$10K/month as an appointment setter, including a $3K base. Works flexible hours, helps improve scripts, and is trusted by leadership for his expertise. Financial milestone: $8,000. Quote: ""Networking is more important than almost anything else... the entire upper tier of jobs is guarded behind knowing someone there."" Advice: "Pay attention to detail-resume, setup, and presentation. Keep applying, learn from every interview, and never quit when it gets hard." Milestone: Offer received.

46. JON BROWNE (12/3/2023): Background: Worked as a consulting biomedical engineer for 4-5 years in pharmaceuticals. Made good money but lacked time, freedom, and fulfillment. Problem: Didn't want the corporate lifestyle or limited freedom. Needed a scalable skill to build financial, time, and geographic independence. Result: Joined the community, landed a remote closing role within three weeks, and now earns $10K/month in 90 days, with multiple higher-paying offers ahead. Financial milestone: $10k. Quote: ""I got my first role within three weeks-every job interview I've had since has come from this community."" Advice: "Leave your ego at the door, surround yourself with high achievers, and shamelessly steal what works-success becomes inevitable if you don't quit." Milestone: Started the role.

47. BENNY SMITH (11/17/2023): Background: From Melbourne, Australia. Traveled to Mexico struggling to find a remote closing job despite four to five years of sales experience, including SDR and closing background. Problem: Moved abroad to find remote work but couldn't land a closing role. Needed income urgently and connection to real opportunities; joined the community for help. Result: Landed a closing role within five days of joining. Later advanced into SDR placement and management, helping others secure vetted B2B offers and training support. Quote: ""Within five days I literally found a role that spoke to me... the community calls are such a highlight of my week."" Advice: "Get in, listen, learn, and network. Even if you can't offer value yet, the community and relationships will fast-track your opportunities." Milestone: Started the role.

48. GEORGE DIVERSIEV (9/28/2023): Background: Worked 18 years in tax resolution sales, closing $2K-$25K packages. Left due to organizational changes and limited growth. Problem: Tired of corporate restrictions, low flexibility, and poor leadership. Wanted freedom and higher earning potential without office politics. Result: Now earns $200K/year closing fitness offers remotely. Made $17K by month three, tripled prior income, and enjoys full lifestyle flexibility. Financial milestone: $200k. Quote: ""My third month check was $17,000-almost triple what I made before. I knew right then this was the move."" Advice: "Find the right offer, study winning reps, and emulate what fits your style. If you stick with it, high-ticket sales will change your life." Milestone: Offer received.

49. DENIZ TURAN (9/12/2023): Background: Played basketball in Turkey and North America, then worked in freelance marketing and for a CBD startup. Returned to Turkey to lower expenses while pursuing online income. Problem: Faced visa issues, inconsistent freelance income, and bad offers in sales. Needed a legitimate opportunity aligned with his values and strong leadership. Result: Now earns $18K/month closing remotely for an offer found inside the community. Built full systems, works 50-60 hours weekly, and became a trusted leader in his company. Financial milestone: $18,000. Quote: ""It took me a year and a half before I made 10K in a month-but that breakthrough changed everything."" Advice: "Stick with it. It's not easy like people say. You'll eat dirt before the breakthrough-but if you keep going, it's worth it." Milestone: Team / scale.

50. CAMILO MOSQUERA (9/11/2023): Background: Tried making money online for four years through trading, agency work, and copywriting-without success or steady income. Problem: Didn't know how to navigate the remote sales space, struggled with scams and unclear direction, and needed structure and verified opportunities. Result: Landed a setting role within three hours of joining the community. Gained clarity, consistency, and connections to real sales opportunities. Quote: ""Just three hours after joining, I was already on a job-same-day delivery as Amazon."" Advice: "If you've got internet, attitude, and speak English-you can do this. It doesn't matter if you're in South America." Milestone: Team / scale.

51. COLE ANGELLE (9/11/2023): Background: Already a seasoned closer and business owner, selling high-ticket offers and running his own ventures before joining the community. Problem: Wanted a stronger network of peers in the same space-people actively selling, growing, and exchanging opportunities. Result: Built high-value relationships, expanded his business network, and gained access to real sales opportunities with other top performers. Quote: ""You can't put a price tag on getting access to people who are on the same mission as you."" Advice: "Get around others doing what you want to do. The right network multiplies your success faster than anything else." Milestone: Offer received.

52. DAN RAGAN (9/11/2023): Background: Already running a successful agency focused on system building and delivery, making ~$50K/month with strong margins but limited outbound or sales structure. Problem: Needed sales support, unbiased feedback, and trustworthy advice when hiring or scaling-tired of wasting time researching and risking bad deals. Result: Now leverages the community for expert feedback, call reviews, and vetted advice to grow confidently toward $100K/month with sales systems and setters. Financial milestone: $100k. Quote: ""Having people in your corner that you can go to and get real recommendations-that's invaluable."" Advice: "Don't scale alone. Get around others who know sales, get real feedback, and invest in community before wasting time or money guessing." Milestone: Team / scale.

53. DANIEL BUTOV (9/11/2023): Background: Had no prior high-ticket sales experience-neither setting nor closing-before joining the community. Problem: Wanted to break into remote sales but lacked direction, experience, and support to present himself well and make a strong first impression. Result: Now working on a large sales team and preparing to transition from setting to closing after just three months in the community. Quote: ""This is probably the best community out there... you can ask anybody for help, and they'll text you back pretty quickly."" Advice: "Absolutely join. If you're new. this is the best place to start and build your sales career." Milestone: Started the role.

54. DREW LONG (9/11/2023): Background: Worked six years in corporate sales management, leading 150 agents and hiring over 100. Highly experienced but seeking new challenges and flexibility. Problem: Felt limited by the corporate world and wanted higher-level, meaningful opportunities beyond traditional leadership roles. Result: Landed a management role at an angel-funded startup within a week of joining-earning cash + equity through a vetted opportunity in the community. Quote: ""You could join the community on a Monday and have three or four interviews lined up by the end of the week."" Advice: "Having a community is essential-networking, feedback, and vetted opportunities make all the difference when stepping away from corporate." Milestone: Started the role.

55. FARDEED AHSAN (9/11/2023): Background: Worked full-time as a UK-based engineer, exploring high-ticket sales for months but struggling to find direction or opportunities while balancing a 9-5. Problem: Couldn't find legitimate offers for part-time setters. Needed structure, connections, and proof that success was possible without quitting his job. Result: Landed a remote closing role within one month, selling $19K in deals with a 25-30% close rate while still working his engineering job. Financial milestone: $19K. Quote: ""I got my first opportunity within a month-and closed $19K while still doing my 9-5."" Advice: "You don't need to burn the boats. Put your head down, apply what's shared, and use the network-it's the only group where everyone truly helps each other." Milestone: Started the role.

56. FERNANDO ANDRES (9/11/2023): Background: Worked typical 9-5 jobs with no prior sales experience before joining the community. Problem: Wanted to break into sales but had no experience or credibility in the space to compete with other applicants. Result: Landed his first sales gig within 2.5 weeks, earning $4K-$5K/month, chosen over 15 other applicants. Financial milestone: $5K. Quote: ""The CEO told me there were 15 applicants-but he picked me because your name and the community were on my resume."" Advice: "Join and leverage the network-it gives you credibility, opportunities, and confidence even if you're brand new." Milestone: Offer received.

57. GEORGE KUZHIKAT (9/11/2023): Background: Background not specified in detail, but joined the community seeking better opportunities and guidance in high-ticket sales. Problem: Didn't know how to find or vet good sales offers and lacked access to legitimate hiring connections before joining. Result: Landed multiple sales roles within weeks, including one through a direct referral. Now receives inbound job offers from strong industry connections. Quote: ""I got my first offer three days after joining... every role I've had since came from the community."" Advice: "Build your name, stay consistent, and leverage the network-once you do, opportunities start finding you." Milestone: Started the role.

58. IAN MIAKO (9/11/2023): Background: Had general sales interest but no structured network or direction before joining the community. Problem: Didn't know where to find legitimate roles or peers to practice with. Needed structure and support to break into high-ticket sales. Result: Landed his first setting role within 48 hours of joining after roleplaying with members and sending footage to a company. Now progressing toward closing positions. Quote: ""Within two days I landed my first role-just from roleplaying with the guys and sending that footage out."" Advice: "Join and network with everyone. The connections and shared resources will fast-track your career in high-ticket sales." Milestone: Team / scale.

59. JASON SOSA (9/11/2023): Background: Worked as a personal trainer and in retail sales, selling $500 packages. Had some cold-calling experience but no remote sales background. Problem: Wanted to enter remote sales but didn't know where to start or how to find legitimate, high-level opportunities. Result: Landed a six-figure remote sales role within one week of joining. Works for a leading company where setters earn $20K-$30K/month. Financial milestone: $30K. Quote: ""I joined Thursday, had my first interview Monday, and got hired that Friday-literally one week."" Advice: "Get in, talk to people, and apply fast. If you put yourself out there and follow the process, you'll land something real quickly." Milestone: Team / scale.

60. JUSTIN SCHMIDT (9/11/2023): Background: Worked as a remote closer but felt misaligned with his offer. Wanted more ownership, leadership, and fulfillment in his sales career. Problem: Felt stuck and stressed in a role that didn't fit. Needed clarity, guidance, and a new direction to align his skills with his goals. Result: Launched a setter management company, signing his first client within 3 days (and a second within a week) through the community's hiring channel. Quote: ""I decided to start the business on the 7th and signed my first client on the 10th-three days later."" Advice: "Lean into the network. The education is great, but the people and connections here are what truly change your life." Milestone: Team / scale.

61. KENDRA (9/11/2023): Background: Was new to sales and learning through YouTube and trial-and-error without real mentorship or structure. Problem: Struggled to find legitimate opportunities or helpful feedback. Needed guidance and real people to learn from instead of online guessing. Result: Landed a strong opportunity through connections in the community. Built faster communication and support through members like Jay. Quote: ""It's like a big melting pot of all the best sales trainings out there-everyone shares what they've learned for free."" Advice: "Join-it's 100% worth it. Even if you don't stay in sales, the network and community alone give a positive ROI." Milestone: Offer received.

62. MEELOD RAHIMI (9/11/2023): Background: He was already a closer but sought stronger industry connections and mentorship to grow his skills and network. Problem: He lacked a reliable network and wanted consistent access to new offers and peers to learn from. Result: He became a million-dollar closer with a strong personal brand and can now find new offers instantly through his community network. Financial milestone: $10K. Quote: ""If I lost my offer today, I could message four or five guys right now and have a new one by tomorrow."" Advice: Invest in relationships-join the community, network constantly, and help others; the opportunities come through who you know, not just what you know. Milestone: Offer received.

63. TERRY EATON (9/11/2023): Background: Recently learned about high-ticket sales through a friend and YouTube. Had no experience but wanted to transition into remote sales. Problem: Didn't know how to identify good offers or avoid scams. Nearly accepted a poor opportunity from Facebook before getting feedback from the community. Result: Now uses proper Outreach and vetting strategies, sends video messages on Instagram, and confidently filters for legitimate, scalable offers. Quote: ""If I wasn't in the community, I probably would've accepted something that wasn't worth my time."" Advice: "Join early-it gives you the roadmap and red flags to avoid before wasting months on bad offers." Milestone: Offer received.

64. TRISTEN NOLAN (9/11/2023): Background: He was working as an insurance adjuster, confused after high school, unsure what to do, and had never been on a Zoom call before joining. Problem: He felt lost and directionless, unsure how to enter remote sales; he joined after seeing a tweet offering help breaking into the space. Result: Now closing for two different high-ticket offers, earning through strong industry connections, and enjoying freedom through remote work opportunities. Quote: ""The value you get from this group is insane. The person you're giving your money to actually cares about developing the community and showing up for you."" Advice: Network relentlessly; knowing people is everything in high-ticket sales-it's how you get the best offers and break in fast. Milestone: Offer received.

65. MARCO GARCIA (9/5/2023): Background: College student and part-time barista with no sales experience. Tried solar sales briefly but lacked direction and income consistency. Problem: Didn't know how to find legitimate sales opportunities. Joined the community to learn how to vet offers and interview properly. Result: Landed a real estate sales role within two weeks, earning $3,300/week ($13K/month) as a setter. Hit top performer status and even wholesaled a property for extra profit. Financial milestone: $3,300. Quote: ""I made $3,300 in one week as an appointment setter-more than I ever thought I could make this fast."" Advice: "Go all in. Apply to everything, follow up, and put in massive volume-luck meets preparation when you stay consistent." Milestone: Started the role.

66. AUSTIN LAMM (n/a): Background: Blue-collar path: lived out of his truck pouring concrete, then project management, roofing sales and door-to-door, then lead PM for a GC in Southwest Florida. High-octane 4am–10pm / 6 days a week on salary and burned out. Also sold roofs for a Tampa company that stopped paying him for weeks. Problem: Burned out on salary PM grind and burned by unpaid roofing sales. Needed a flexible income vehicle that still used his sales skill so he could fund building his own company — not another in-person grind. Result: Joined TSSC Feb 2025, skipped setting and went straight into closing on a biz-op offer (about a year and a half). Cleared over six figures as a remote closer / contractor and used that income to launch his own company (hardware-agnostic global refinement layer). Financial milestone: $100k+. Quote: "There's not a better vehicle than getting in the high ticket remote sales to make that kind of revenue that's going to allow you to pursue things you want to do." Advice: Sales was the right skill — the old in-person vehicles were wrong. Prepare obsessively, take the leap when the math makes sense, and use remote closing as flexible fuel for the business you actually want to build. Milestone: Team / scale.

67. FRANKLYN PACHE (n/a): Background: 19–20 years old in Orlando doing gym sales (~$42K/year). Felt capped and wanted more purpose, direction, and earning potential. Problem: Didn't want to stay stuck at ~$50K ceiling in gym sales. Needed a leap into remote appointment setting with mentorship and a vetted path. Result: Quit gym sales, joined the community (Apr 2025), and within ~8 months was setting remotely—hitting ~$9.4K–$11.6K months and ~$30K across a quarter. Moved toward Austin for opportunity. Financial milestone: $11.6K. Quote: ""Definitely still look at it as a job. Don't look at it as a get-rich-quick scheme... Choose your hard."" Advice: Treat remote sales like a real job, learn to reverse-engineer and vet offers (team size, cash collected, churn), and surround yourself with high performers. Milestone: Income jump.

68. JOSH CZUBA (n/a): Background: Hangout / weekend coffee meetup in Austin with local remote sales members (mix of experienced and new). Not a single-person success interview. Advice: Get offline and talk to people in the game—network and referrals compound; showing up (community calls, meetups) correlates with better long-term results.

69. KADE THIXTON (n/a): Background: College student working part-time at Home Depot, barely attending classes. Had tried ecom, NFTs, and other online money ideas without success. Problem: Needed real income (car loan, engagement ring) while stuck in a low-leverage job. Didn't know how to break into remote high-ticket sales. Result: Went setter → closer → manager. Now hits ~$30K months from closing alone (part-time ~40 hrs/month), has had $50K months, manages multiple offers, and is building a YouTube/sales-management offer. Financial milestone: $30,000. Quote: ""Focus on the journey rather than the destination... I found so much more joy and success just wanting to work before seeing the results."" Advice: Stay longer in setting before rushing to closing; the best closers usually have thorough setting experience. Drop the ego about not needing help, and put in the work before chasing outcomes. Milestone: Income jump.
...
export default function ChatPage() {
  ...
  return (
    <div className="sq-app">
      ...
      <div className="sq-messages-wrap" ref={messagesContainerRef}>
        {isEmpty && (
          <div className="sq-empty-state">
            <div className="sq-empty-hero">
              <p className="sq-empty-title">The most successful minds of TSSC in your pocket.</p>
              <p className="sq-empty-sub">Ask anything about breaking into remote appointment setting or closing. Literally anything.</p>
            </div>
            <div className="sq-empty-suggestions">
              {SUGGESTIONS.map((s) => (
                <button key={s.prompt} className="sq-suggestion-chip" onClick={() => handleSuggestion(s)}>
                  {s.label}
                </button>
              ))}
              <a href="https://serialsalescommunity.co/" target="_blank" rel="noopener noreferrer" className="sq-suggestion-chip cta">
        ...
        {loading && (
          <div className="sq-bubble-row assistant">
            <div className="sq-bubble assistant typing">
      ...
      <div className="sq-bottom">
        {!isEmpty && (
          <>
            <div className="sq-suggestions-hint-wrap">
              <span className="sq-suggestions-hint">scroll to select a prompt, or type your own.</span>
            </div>
            <div className="sq-suggestions-scroll">
              {SUGGESTIONS.map((s) => (
                <button key={s.prompt} className="sq-suggestion-chip" onClick={() => handleSuggestion(s)}>
                  {s.label}
                </button>
        ...
        <form className="sq-input-row" onSubmit={handleSubmit}>
          <textarea
            ref={inputRef}
            className="sq-input-box"
            value={input}
            ...
            rows={1}
          />
          <button type="submit" className="sq-send-btn" disabled={loading || !input.trim()}>
      ...
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (min-width: 520px) {
          .sq-header { padding: 15px 28px 14px; }
        }
        ...
        @media (min-width: 520px) {
          .sq-messages-wrap { padding: 22px 28px 12px; gap: 12px; }
        }

        .sq-messages-wrap::-webkit-scrollbar { width: 0; }
        ...
        .sq-bubble-row.user { justify-content: flex-end; }
        .sq-bubble-row.assistant { justify-content: flex-start; }
        ...
        .sq-bubble-row.assistant .sq-bubble { max-width: 90%; }
        ...
        .sq-dot:nth-child(2) { animation-delay: 0.2s; }
        .sq-dot:nth-child(3) { animation-delay: 0.4s; }
        ...
        .sq-suggestions-scroll::-webkit-scrollbar { display: none; }
        ...
        .sq-suggestion-chip:not(.cta):active { transform: scale(0.96); }

        .sq-suggestion-chip:hover, .sq-suggestion-chip:active {
          background: #232730;
          border-color: rgba(182, 205, 222, 0.35);
        }

        .sq-suggestion-chip.cta {
          background: #b6cdde;
          color: #0d0f12;
          border-color: #b6cdde;
          font-weight: 600;
        ...
        @media (min-width: 520px) {
          .sq-input-row { padding: 10px 28px 18px; }
        }
        ...
        .sq-input-box::placeholder { color: #4a5568; }
        ...
        .sq-send-btn:not(:disabled) { box-shadow: 0 4px 14px rgba(182, 205, 222, 0.25); }
        .sq-send-btn:not(:disabled):hover { background: #cddae6; }
        .sq-send-btn:disabled { opacity: 0.3; cursor: default; box-shadow: none; }
        .sq-send-btn:not(:disabled):active { transform: scale(0.92); }
