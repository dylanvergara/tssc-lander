    ...
    <>
      <section className="short-hero">
        ...
        <div className="short-hero__content">
          ...
          <h1 className="short-hero__headline">Here&apos;s how people are landing quality 1099 remote sales roles in 3&ndash;5 weeks with our process:</h1>
          ...
          <p className="short-hero__microcopy">Trusted by 500+ reps since 2022 to land remote sales roles with internet businesses who know how to drive inbound leads</p>
