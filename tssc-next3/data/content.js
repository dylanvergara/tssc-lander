...
export const siteData = {
  ...
  events: {
    ...
    images: [
      { src: '/images/events/community-workshop.jpg',   caption: 'Live workshop — members learning together' },
      { src: '/images/events/community-dinner.jpg',     caption: 'Community dinner night' },
      { src: '/images/events/community-pool.jpg',       caption: 'Beating the heat' },
      { src: '/images/events/community-party.jpg',      caption: 'TSSC meetup night out' },
      { src: '/images/events/community-cigars.jpg',     caption: 'Boat cigars with the TSSC gang' },
      { src: '/images/events/community-brunch.jpg',     caption: 'Member brunch meetup' },
      { src: '/images/events/community-donuts.jpg',     caption: 'Running marathons together' },
      { src: '/images/events/community-restaurant.jpg', caption: 'Community dinner — local chapter' },
      { src: '/images/events/community-barcelona.jpg',  caption: 'Barcelona with a TSSC Member' },
      { src: '/images/events/community-tokyo.jpg',      caption: 'Tokyo with a TSSC Member' },
    ],
  },
