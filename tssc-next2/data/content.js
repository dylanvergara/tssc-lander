...
export const siteData = {
  ...
  process: {
    ...
    steps: [
      { number: '01', title: 'Onboard',  body: '1-1 onboarding call with Carolyn. TSSC custom roadmap call with Dylan.' },
      { number: '02', title: 'Position', body: 'Market positioning call with Dylan. New member care package received.' },
      { number: '03', title: 'Apply',    body: 'CSM check-ins and reports. Hiring open floor with Dylan and Jackson.' },
